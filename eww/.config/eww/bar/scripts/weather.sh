...
translate_weather_desc() {
    ...
    case $desc in
        ...
        *"few clouds"*) echo "Lekkie Zachmurzenie" ;;
        *"scattered clouds"*) echo "Pochmurno" ;;
        *"broken clouds"*) echo "Duże Zachmurzenie" ;;
...
get_data() {
    ...
    if [ ! -z "$processed_forecast" ]; then
        ...
        for d in $dates; do
            ...
            f_pop_pct=$(echo "$f_pop" | awk '{printf "%.0f\n", $0 * 100}')
            ...
            for i in $(seq 0 1 $count_slots); do
                ...
                # CHANGED: Round temperature in jq

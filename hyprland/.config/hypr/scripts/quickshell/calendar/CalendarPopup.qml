...
FloatingWindow {
    ...
    readonly property string scriptsDir: "/home/michal/.config/hypr/scripts/quickshell/calendar"
    ...
    // SCHEDULE DATA
    // -------------------------------------------------------------------------
    property var scheduleData: { "header": "Ładowanie planu...", "link": "", "lessons": [] }
    ...
    function getPolishDayName(dayIndex) {
        const days = ["niedziela", "poniedziałek", "wtorek", "środa", "czwartek", "piątek", "sobota"];
        return days[dayIndex];
    }

    function formatPolishDate(date) {
        const dayName = getPolishDayName(date.getDay());
        const day = date.getDate();
        const monthName = getPolishMonthName(date.getMonth());
        ...
        Rectangle {
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text {
                            text: {
                                ...
                                let m = window.currentTime.getMinutes();
                    ...
                    Text {
                        Layout.alignment: Qt.AlignHCenter
                        text: formatPolishDate(window.currentTime)
                        font.family: "JetBrains Mono"
                        font.weight: Font.Bold
                        font.pixelSize: 16
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text { 
                            text: window.scheduleData ? window.scheduleData.header : "Ładowanie planu..."
                            font.family: "JetBrains Mono"
                            font.weight: Font.Bold
                    ...
                    Item {
                        ...
                        Text {
                            text: "Brak połączenia. Brak zaplanowanych wydarzeń."
                            font.family: "JetBrains Mono"
                            font.italic: true
                            font.pixelSize: 14
                            color: window.overlay0

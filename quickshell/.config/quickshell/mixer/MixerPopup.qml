...
ShellRoot {
    ...
    FloatingWindow {
        ...
        Item {
            ...
            transform: Translate { y: root.s(20) * (1 - root.introMain) }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Item {
                        ...
                        transform: Translate { y: root.s(30) * (1.0 - root.introHeader) }
                                ...
                                Rectangle {
                                    ...
                                    Canvas {
                                        ...
                                        onPaint: {
                                            ...
                                            if (root.activeVol <= 0) return;

                                            var fillRatio = root.activeVol / 100.0;
                                            var r = width / 2;
                                    ...
                                    Item {
                                        ...
                                        property real fillRatio: root.activeVol / 100.0
                            ...
                            ColumnLayout {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        ...
                                        font.family: "JetBrains Mono"; font.weight: Font.Black; font.pixelSize: root.s(20)
                                        color: root.text
                                ...
                                RowLayout {
                                    ...
                                    Item {
                                        ...
                                        Rectangle {
                                            anchors.fill: parent; radius: root.s(12)
                    ...
                    Rectangle {
                        ...
                        border.width: 1
                        opacity: root.introHeader
                        transform: Translate { y: root.s(20) * (1.0 - root.introHeader) }
                        ...
                        Rectangle {
                            ...
                            radius: root.s(10)
                            x: {
                                if (root.activeTab === "outputs") return root.s(1);
                                if (root.activeTab === "inputs") return width + root.s(1);
                        ...
                        RowLayout {
                            ...
                            Repeater {
                                model: ListModel {
                                    ListElement { tabId: "outputs"; icon: "󰓃"; label: "Wyjścia" } 
                                    ListElement { tabId: "inputs"; icon: "󰍬"; label: "Wejścia" }   
                                    ListElement { tabId: "apps"; icon: "󰎆"; label: "Aplikacje" } 
                                }
                                ...
                                delegate: Item {
                                    ...
                                    RowLayout {
                                        ...
                                        spacing: root.s(8)
                                        Text {
                                            font.family: "CaskaydiaCove Nerd Font"; font.pixelSize: root.s(18)
                                            color: root.activeTab === tabId ? root.crust : (tabMa.containsMouse ? root.text : root.subtext0)
                                            text: icon
                                            Behavior on color { ColorAnimation { duration: 200 } }
                                        }
                                        Text {
                                            font.family: "CaskaydiaCove Nerd Font"; font.weight: Font.Black; font.pixelSize: root.s(13)
                                            color: root.activeTab === tabId ? root.crust : (tabMa.containsMouse ? root.text : root.subtext0)
                                            text: label
                                            Behavior on color { ColorAnimation { duration: 200 } }
                                        }
                    ...
                    Item {
                        ...
                        transform: Translate { y: root.s(20) * (1.0 - root.introContent) }
                        ...
                        ListView {
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    anchors.centerIn: parent
                                    spacing: root.s(10)
                                    Text { Layout.alignment: Qt.AlignHCenter; font.family: "CaskaydiaCove Nerd Font"; font.pixelSize: root.s(32); color: root.surface2; text: "󰖁" }
                                    Text { Layout.alignment: Qt.AlignHCenter; font.family: "CaskaydiaCove Nerd Font"; font.pixelSize: root.s(14); color: root.overlay0; text: "Brak aktywnych strumieni" }
                                }
                            }
                            ...
                            delegate: Rectangle {
                                ...
                                transform: Translate { y: isLoaded ? 0 : root.s(15) }
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        Text {
                                            font.family: "CaskaydiaCove Nerd Font"; font.pixelSize: root.s(22)
                                        ...
                                        ColumnLayout {
                                            ...
                                            Text {
                                                Layout.fillWidth: true; elide: Text.ElideRight
                                                font.family: "CaskaydiaCove Nerd Font"; font.weight: Font.Bold; font.pixelSize: root.s(14)
                                                color: isActiveNode ? root.crust : root.text
                                                text: model.description
                                            }
                                            Text {
                                                Layout.fillWidth: true; elide: Text.ElideRight
                                                font.family: "CaskaydiaCove Nerd Font"; font.pixelSize: root.s(11)
                                    ...
                                    RowLayout {
                                        ...
                                        Rectangle {
                                            Layout.preferredWidth: root.s(32); Layout.preferredHeight: root.s(32); radius: root.s(16)
                                        ...
                                        Item {
                                            ...
                                            Rectangle {
                                                anchors.fill: parent; radius: root.s(7)
                                                color: "#0dffffff"; border.color: "#1affffff"; border.width: 1
                                                clip: true
                                        ...
                                        Text {
                                            ...
                                            font.family: "CaskaydiaCove Nerd Font"; font.weight: Font.Bold; font.pixelSize: root.s(12)
                                            color: root.subtext0
                                            text: model.volume + "%"

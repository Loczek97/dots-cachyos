...
FloatingWindow {
    ...
    // Start in WiFi mode (Bluetooth not available on this system)
    ...
    readonly property bool currentPower: activeMode === "wifi" ? (window.wifiPower === "on" || (window.wifiPower === "" && window.isWifiConn)) : (window.btPower === "on" || (window.btPower === "" && window.isBtConn))
    ...
    function updateInfoNodes() {
        ...
        if (window.currentConn && window.currentObj) {
            if (window.activeMode === "wifi") {
                ...
                nodes.push({
                    "id": "sec",
                    "name": window.currentObj.security || "Otwarta",
                    "icon": "󰦝",
                    "action": "Zabezpieczenie",
                    "isInfoNode": true,
                    "isActionable": false
                });
                if (window.currentObj.ip)
                    nodes.push({
                    "id": "ip",
                    "name": window.currentObj.ip,
                    "icon": "󰩟",
                    "action": "Adres IP",
                    "isInfoNode": true,
                    "isActionable": false
                ...
                if (window.currentObj.freq)
                    nodes.push({
                    "id": "freq",
                    "name": window.currentObj.freq,
                    "icon": "󰖧",
                    "action": "Pasmo",
                    "isInfoNode": true,
                    "isActionable": false
                ...
                nodes.push({
                    "id": "bat",
                    "name": (window.currentObj.battery || "0") + "%",
                    "icon": "󰥉",
                    "action": "Bateria",
                    "isInfoNode": true,
                    "isActionable": false
                ...
                if (window.currentObj.profile)
                    nodes.push({
                    "id": "prof",
                    "name": window.currentObj.profile,
                    "icon": (window.currentObj.profile === "Wysoka jakość (A2DP)" ? "󰓃" : "󰋎"),
                    "action": "Profil audio",
                    "isInfoNode": true,
                    "isActionable": false
                });
                ...
                nodes.push({
                    "id": "mac",
                    "name": window.currentObj.mac || "Nieznany",
                    "icon": "󰒋",
                    "action": "Adres MAC",
                    "isInfoNode": true,
                    "isActionable": false
                ...
                if (this.text) {
                    ...
                    if (textData.length > 0) {
                        try {
                            ...
                            if (jsonData.power)
                                window.wifiPower = jsonData.power;

                            if (jsonData.connected !== undefined)
                                window.wifiConnected = jsonData.connected;
                            ...
                            if (jsonData.networks) {
                                ...
                                if (window.isWifiConn && window.activeMode === "wifi")
                                    nets.push({
                                    "id": "action_settings",
                                    "ssid": "Aktualne urządzenie",
                                    "mac": "",
                                    "name": "Aktualne urządzenie",
                                    "icon": "󰒓",
                                    "security": "",
        ...
        stdout: StdioCollector {
            onStreamFinished: {
                ...
                if (success) {
                    ...
                    window.wifiPasswordPopupVisible = true;
                    window.wifiPromptError = wrongPassword ? "Nieprawidłowe hasło. Spróbuj ponownie." : "Ta sieć wymaga hasła";
                ...
                if (this.text) {
                    ...
                    if (textData.length > 0) {
                        try {
                            let jsonData = JSON.parse(textData);
                            if (jsonData.power)
                                window.btPower = jsonData.power;

                            if (jsonData.connected !== undefined)
                                window.btConnected = jsonData.connected;
                            ...
                            if (window.activeMode === "bt" && window.currentConn)
                                window.updateInfoNodes();

                        } catch (e) {
                            console.log("BT parse error:", e);
                        }
                    }
                }
            }
    ...
    Item {
        ...
        Rectangle {
            ...
            Item {
                ...
                opacity: window.currentPower ? 1 : 0
            ...
            Canvas {
                ...
                anchors.bottomMargin: 80
                z: 0
                opacity: (window.currentConn && window.showInfoView) ? 1 : 0
                onPaint: {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    border.color: {
                        ...
                        if (window.busyTask === "DISCONNECTING")
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            ...
                            var r = width / 2;
                            var fillY = height * (1 - centralCore.disconnectFill);
                            ctx.save();
                            ctx.beginPath();
                        ...
                        NumberAnimation on wavePhase {
                            running: centralCore.disconnectFill > 0 && centralCore.disconnectFill < 1
                    ...
                    Rectangle {
                        ...
                        opacity: window.currentConn && window.busyTask !== "DISCONNECTING" ? (centralCore.isDangerState ? 0.3 : 0.15) : 0
                        z: -1
                    ...
                    Item {
                        ...
                        ColumnLayout {
                            ...
                            LoadingDots {
                                Layout.alignment: Qt.AlignHCenter
                                visible: window.busyTask === "DISCONNECTING"
                        ...
                        NumberAnimation {
                            ...
                            to: 1
                            duration: 700 * (1 - centralCore.disconnectFill)
                            ...
                            onFinished: {
                                ...
                                busyTimeout.start();
                                let cmd = window.activeMode === "wifi" ? "nmcli device disconnect $(nmcli -t -f DEVICE,TYPE d | grep wifi | cut -d: -f1 | head -n1)" : "bash " + window.scriptsDir + "/bluetooth_panel_logic.sh --disconnect " + window.currentObj.mac;
                                Quickshell.execDetached(["sh", "-c", cmd]);
                                centralCore.disconnectFill = 0;
                ...
                Item {
                    anchors.fill: parent
                    opacity: window.currentPower ? 1 : 0
                    scale: window.currentPower ? 1 : 0.5
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            property real dynamicScale: activeCount > 10 ? Math.max(0.75, 12 / activeCount) : 1
                            ...
                            property real flashOpacity: 0
                            property real renderFill: (isCurrentlyConnected) ? 1 : fillLevel
                            ...
                            scale: (!isLoaded ? 0 : (floatMa.pressed ? dynamicScale * 0.95 : (locksList ? dynamicScale * 1.08 : dynamicScale))) * bumpScale
                            ...
                            Rectangle {
                                anchors.fill: parent
                                radius: 16
                                opacity: locksList || isHighlighted ? 1 : 0
                                color: "transparent"
                            ...
                            Canvas {
                                ...
                                NumberAnimation on wavePhase {
                                    running: floatCard.renderFill > 0 && floatCard.renderFill < 1
                                    loops: Animation.Infinite
                                    from: 0
                                    to: Math.PI * 2
                                    duration: 800
                            ...
                            RowLayout {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        ...
                                        text: floatCard.isMyBusy ? "Łączenie..." : (floatCard.renderFill > 0.1 && floatCard.renderFill < 1 ? "Trzymaj..." : action)
                            ...
                            MouseArea {
                                ...
                                cursorShape: (window.busyTask !== "" || floatCard.triggered || floatCard.isMyBusy || floatCard.renderFill === 1 || !floatCard.isInteractable) ? Qt.ArrowCursor : Qt.PointingHandCursor
                                onPressed: {
                                    if (floatCard.isInteractable && window.busyTask === "" && !floatCard.triggered && !floatCard.isMyBusy && floatCard.fillLevel === 0) {
                                        drainAnim.stop();
                                        fillAnim.start();
                                    }
                                }
                                onReleased: {
                                    if (floatCard.isInteractable && !floatCard.triggered && !floatCard.isMyBusy && floatCard.fillLevel < 1) {
                                        fillAnim.stop();
                                        drainAnim.start();
                                    }
                                }
                            ...
                            NumberAnimation {
                                ...
                                property: "fillLevel"
                                to: 1
                                duration: 600 * (1 - floatCard.fillLevel)
                                easing.type: Easing.InSine
                                onFinished: {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            anchors.fill: parent
                            radius: 21
                            opacity: window.activeMode === "wifi" ? 1 : 0
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            anchors.fill: parent
                            radius: 21
                            opacity: window.activeMode === "bt" ? 1 : 0
            ...
            Rectangle {
                ...
                border.width: 2
                scale: pwrMa.pressed ? 0.9 : (pwrMa.containsMouse ? 1.1 : 1)
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                height: 38
                                radius: 12
                                opacity: window.busyTask === window.wifiPromptSsid ? 0.75 : 1
